 ...
 */
public class NewPostGroupServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String result = utilPost.createPost(owner, post, "group", goid, "");
        if( result.equalsIgnoreCase("Done!") ) {
           activity.createActivity(util.getPersonName(owner), ActivityVerb.POST.toString(), 
                                                                    goid.toString(), "group");
        }
    }
